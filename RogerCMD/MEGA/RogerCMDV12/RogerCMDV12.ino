...
void vruModeExitError() {
  ...
  delay(350);
  queueVoiceResponse(106);                        //  Current
  delay(350);
  queueVoiceResponse(171);                        //  Mode
  delay(1500);
}
...
void vruDistToDestError(float dtdError) {
  ...
  delay(350);
  queueVoiceResponse(94);                        //  Estimate 
  delay(350);
  queueVoiceResponse(107);                       //  Error
  delay(350);
...
void vruSayDistToDest(float distToDestination) {
  ...
  uint16_t msdDTD = distToDestination;
  delay(350);
...
//
void chkMainBattery() {
  int mainVolt = analogRead(LOWBATPIN);
  delay(50);
  if (mainVolt <= 450) {
    mainBatteryLow = true;
    } else {
